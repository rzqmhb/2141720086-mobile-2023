...
2. output:<br> ![output](docs/mobile.gif)
...
2. output : <br> ![output](docs/mobile-1.gif)
...
2. output : <br> ![output](docs/mobile-2.gif)
...
2. output : <br> ![output](docs/mobile-3.gif)
 
#### Soal 7
Capture hasil praktikum Anda berupa GIF dan lampirkan di README. Lalu lakukan commit dengan pesan "W12: Soal 7".
##### Jawaban :
![Alt text](docs/mobile-4.gif)
...
2. output : <br> ![Alt text](docs/image-4.png) <br> ![Alt text](docs/mobile-7.gif)
...
##### Jawaban :
1. kode : <br >![Alt text](docs/image-6.png)
2. jika aplikasi dijalankan menggunakan emulator browser, maka akan tetap mendapatkan koordinat lokasi <br> emulator browser : <br> ![Alt text](docs/image-7.png) <br> ![Alt text](docs/image-8.png)
3. emulator AndroidStudio : <br> ![Alt text](docs/mobile-8.gif) <br> emulator smartphone : <br> ![Alt text](docs/mobile-9.gif)
...
2. output : <br> ![Alt text](docs/mobile-10.gif)
...
2. output : <br> ![Alt text](docs/mobile-11.gif)
 
#### Soal 15
* Tambahkan nama panggilan Anda pada tiap properti title sebagai identitas pekerjaan Anda.
* Silakan ganti dengan warna tema favorit Anda.
##### Jawaban :
1. Menambahkan nama : <br> ![Alt text](docs/image-9.png) <br> ![Alt text](docs/image-10.png) <br> ![Alt text](docs/image-11.png)
2. ![Alt text](docs/image-12.png)
...
2. ubah warna : <br> ![Alt text](docs/image-13.png)
3. output : <br> ![Alt text](docs/mobile-12.gif)
...
##### Jawaban :
1. Hasilnya sebagian sama seperti praktikum sebelumnya, hanya saja pada praktikum ini, tidak dilakukan navigasi ke halaman lainnya. Sebaliknya, tombol "Change Color" akan menjalankan function _showDialog() yang akan menampilkan dialog yang berisi tombol untuk merubah warna background scaffold tanpa meninggalkan halaman awal.
2. mengganti warna : <br> ![Alt text](docs/image-14.png)
3. output : <br> ![Alt text](docs/mobile-13.gif)
